...
![迭代器设计模式](../assets/迭代器设计模式.png)

##  问题

集合是编程中最常使用的数据类型之一。 尽管如此， 集合只是一组对象的容器而已。

![各种类型的集合](../assets/各种类型的集合.png)
...
![迭代器可以实现不同算法](../assets/迭代器可以实现不同算法.png)
...
![漫步罗马的不同方式](../assets/漫步罗马的不同方式.png)
...
![迭代器设计模式的结构](../assets/迭代器设计模式的结构.png)
...
![迭代器模式示例的结构](../assets/迭代器模式示例的结构.png)

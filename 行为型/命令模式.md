...
![GUI 层可以直接访问业务逻辑层](GUI_层可以直接访问业务逻辑层.png)
...
![GUI 对象将命令委派给命令对象](GUI_对象将命令委派给命令对象.png)

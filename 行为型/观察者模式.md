...
![访问商店或发送垃圾邮件](../assets/访问商店或发送垃圾邮件.png)
...
![观察者设计模式的结构](../assets/观察者设计模式的结构.png)
...
![观察者模式示例的结构](../assets/观察者模式示例的结构.png)

...
![组合模式建议的解决方案](../assets/组合模式建议的解决方案.png)
...
![组合设计模式的结构](../assets/组合设计模式的结构.png)
...
![组合模式示例的结构](../assets/组合模式示例的结构.png)

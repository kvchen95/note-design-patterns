...
![将图像导出为 XML](../assets/将图像导出为_XML.png)
...
![所有节点的类中都必须添加导出至 XML 文件的方法](../assets/所有节点的类中都必须添加导出至_XML_文件的方法.png)
...
![访问者设计模式的结构](../assets/访问者设计模式的结构.png)
...
![访问者模式示例的结构](../assets/访问者模式示例的结构.png)

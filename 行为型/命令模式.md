...
![GUI 层可以直接访问业务逻辑层](../assets/GUI_层可以直接访问业务逻辑层.png)
...
![通过命令访问业务逻辑层。](../assets/通过命令访问业务逻辑层。.png)
...
![GUI 对象将命令委派给命令对象](../assets/GUI_对象将命令委派给命令对象.png)
...
![命令设计模式的结构](../assets/命令设计模式的结构.png)
...
![命令模式示例的结构](../assets/命令模式示例的结构.png)
